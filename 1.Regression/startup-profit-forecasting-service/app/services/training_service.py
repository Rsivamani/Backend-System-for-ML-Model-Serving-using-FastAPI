"""
Training Service — Business Intelligence Profit Prediction (MLR base)
...
Features: R&D Spend, Administration, Marketing Spend (numeric) + State (categorical)
Target: Profit
Selection metric: Highest test R² + lowest overfitting gap
"""
...
class TrainingService:
    """
    Trains all candidate regressors on the 50_Startups dataset,
    compares R²/MAE/MSE, checks overfitting, and saves the best pipeline.
    """
    ...
    def train(self) -> Dict[str, Any]:
        ...
        for name, estimator in CANDIDATE_MODELS.items():
            ...
            logger.info("%s | test_R²=%.4f | MAE=%.2f | overfit_gap=%.4f", name, test_r2, mae, overfit_gap)
        ...
        return {
            ...
            "selection_reason": (
                f"{best_model_name} achieved the highest test R² ({round(best_r2, 4)}) "
                "indicating best generalisation on unseen data."
            ),
