"""Routes for DT Classification API."""
...
def health():
    return {"status": "ok", "service": "Social Network Ads — DT Classification API"}


@training_router.post("/", summary="Train Decision Tree Classifier")
def train():
    try:
...
@prediction_router.post("/", response_model=PurchasePredictionResponse, summary="Predict Purchase")
