"""
Training Service — Social Network Ads Purchase Prediction (SVM-CLF base)
...
CANDIDATE_MODELS = {
    ...
    "RandomForestClassifier": RandomForestClassifier(n_estimators=100, criterion="entropy", random_state=settings.random_state),
    "SVC": SVC(kernel="rbf", C=1.0, probability=True, random_state=settings.random_state),
}


class TrainingService:
    """Multi-model classifier selection — SVM project variant."""
    ...
    def train(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "selection_reason": (
                f"{best_model_name} achieved the best F1 score ({round(best_f1, 4)}) "
                "reflecting best trade-off between precision and recall."
            ),
