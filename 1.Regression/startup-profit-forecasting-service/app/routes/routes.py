"""Routes for MLR Profit Prediction API."""
...
def health():
    return {"status": "ok", "service": "Business Intelligence MLR API"}


@training_router.post("/", summary="Train MLR Model")
def train():
    try:
...
@prediction_router.post("/", response_model=ProfitPredictionResponse, summary="Predict Profit")
