"""Routes for RF Classification API."""
...
def health():
    return {"status": "ok", "service": "Social Network Ads — RF Classification API"}


@training_router.post("/", summary="Train Random Forest Classifier")
def train():
    try:
...
@prediction_router.post("/", response_model=PurchasePredictionResponse, summary="Predict Purchase (RF)")
